...
Logentries = (function(superClass) {
  ...
  function Logentries(arg) {
    var level, levels, ref, ref1, ref2, secure, timestamp, token;
    token = arg.token, level = arg.level, levels = (ref = arg.levels) != null ? ref : winston.levels, secure = (ref1 = arg.secure) != null ? ref1 : true, timestamp = (ref2 = arg.timestamp) != null ? ref2 : true;
